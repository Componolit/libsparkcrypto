theory lscmnripemd160_Lsc__ripemd160__hash_context__subprogram_def_WP_parameter_def_1
imports "../SPARK2014"
begin

why3_open "lscmnripemd160_Lsc__ripemd160__hash_context__subprogram_def_WP_parameter_def_1.xml"
...
proof -
  ...
  with `BV64.ugt (unsigned_64_to_rep (first (rt message)) +
    length1 div of_int 512) (unsigned_64_to_rep (first (rt message)))`
  ...
  show ?thesis
    by (simp add: `_ = r124b` [symmetric] BV64.ule_def word_le_def
