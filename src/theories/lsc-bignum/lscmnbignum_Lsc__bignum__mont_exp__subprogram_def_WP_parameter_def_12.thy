theory lscmnbignum_Lsc__bignum__mont_exp__subprogram_def_WP_parameter_def_12
imports "../LibSPARKcrypto"
begin

why3_open "lscmnbignum_Lsc__bignum__mont_exp__subprogram_def_WP_parameter_def_12.xml"
...
proof -
  ...
  with R show ?thesis by (simp add: base_eq)
qed
