theory lscmnbignum_Lsc__bignum__mont_exp__subprogram_def_WP_parameter_def_13
imports "../LibSPARKcrypto"
begin

why3_open "lscmnbignum_Lsc__bignum__mont_exp__subprogram_def_WP_parameter_def_13.xml"
...
proof -
  ...
  from `\<forall>k. aux1_first \<le> k \<and> k \<le> aux1_first + (a_last - a_first) \<longrightarrow>
    aux1 k = of_int 0`
    `a_first < a_last` `o1 = _`
  have one: "num_of_big_int' (Array (aux1(aux1_first := o1)) \<langle>\<lfloor>aux1__first\<rfloor>\<^sub>\<int>\<dots>\<lfloor>aux1__last\<rfloor>\<^sub>\<int>\<rangle>)
    aux1_first (a_last - a_first + 1) = 1"
