theory lscmnbignum_Lsc__bignum__mont_exp_window__subprogram_def_WP_parameter_def_20
imports "../LibSPARKcrypto"
begin

why3_open "lscmnbignum_Lsc__bignum__mont_exp_window__subprogram_def_WP_parameter_def_20.xml"
...
proof -
  ...
  have "(h1 - 1) * (a_last - a_first + 1) \<le>
    ...
    by simp
  with `a_first < a_last`
  have "(h1 - 1) * (a_last - a_first + 1) + (a_last - a_first) \<le>
