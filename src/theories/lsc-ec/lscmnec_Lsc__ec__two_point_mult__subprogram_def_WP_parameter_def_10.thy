theory lscmnec_Lsc__ec__two_point_mult__subprogram_def_WP_parameter_def_10
imports "../Elliptic_Spec"
begin

why3_open "lscmnec_Lsc__ec__two_point_mult__subprogram_def_WP_parameter_def_10.xml"
  ...
  note eq3 =
    `point_add_spec _ _ _ _ _ _ _ _ (num_of_big_int' (Array x33 _) _ _) _ _ = _`
      [my_simplified point_add_spec_def Let_def slide_eq mk_bounds_eqs integer_in_range_def defs
       ...
       on_curvep2 on_curvep_imp_in_carrierp [of ?a b], symmetric]

  with a b d\<^sub>2' on_curvep2
