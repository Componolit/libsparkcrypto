...
why3_vc WP_parameter_def
  using
    ...
    `\<forall>k. \<lfloor>x3_first1\<rfloor>\<^sub>\<nat> \<le> k \<and> k \<le> \<lfloor>x3_first1\<rfloor>\<^sub>\<nat> + \<lfloor>o1\<rfloor>\<^sub>\<nat> \<longrightarrow> \<lfloor>x3 k\<rfloor>\<^bsub>w32\<^esub> = 0`
