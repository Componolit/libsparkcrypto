...
why3_vc WP_parameter_def
  using
    ...
    `mk_map__ref x3 = mk_map__ref x31`
    `mk_map__ref x31 = mk_map__ref x32`
    `mk_map__ref y3 = mk_map__ref y31`
    `mk_map__ref y31 = mk_map__ref y32`
    `mk_map__ref z3 = mk_map__ref z31`
    `mk_map__ref z31 = mk_map__ref z32`
    `e1_first \<le> e1_last`
