theory lscmnec_Lsc__ec__point_add__subprogram_def_WP_parameter_def_32
imports "../Elliptic_Spec"
begin

why3_open "lscmnec_Lsc__ec__point_add__subprogram_def_WP_parameter_def_32.xml"
...
proof -
  ...
  have "Z\<^sub>3 = Z\<^sub>1"
    by (simp add: Z\<^sub>1_def Z\<^sub>3_def add_diff_eq num_of_lint_ext)
  ultimately show ?thesis
    by (simp add: point_add_spec_def point_double_spec_def padd_def proj_eq_def
      ...
      res_of_int_eq res_pow_eq defs map__content_def)
qed
