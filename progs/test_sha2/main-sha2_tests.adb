...
procedure SHA2_Tests is
   ...
   Hash1, Hash2, Hash3              : LSC.SHA2.Hash_Type;
...
begin
   ...
   SHA2_Ctx2     := LSC.SHA2.Context_Init;
   Message2 :=
     LSC.SHA2.Block_Type'
     (16#6162636465666768#,
      16#6263646566676869#,
   ...
   Hash2 := LSC.SHA2.Get_Hash (SHA2_Ctx2);

   LSC.Test.Run
     ("SHA-512 Example (Multi-Block Message)",
      Hash2 =
      LSC.SHA2.Hash_Type'(16#8e959b75dae313da#,
                          16#8cf4f72814fc143f#,
                          16#8f7779c6eb9f7fa1#,
                          16#7299aeadb6889018#,
                          16#501d289e4900f7e4#,
   ...
   SHA2_Ctx3 := LSC.SHA2.Context_Init;
   ...
   Hash3 := LSC.SHA2.Get_Hash (SHA2_Ctx3);

   LSC.Test.Run
     ("SHA-512 Example (Long Message)",
      Hash3 =
      LSC.SHA2.Hash_Type'(16#e718483d0ce76964#,
                          16#4e2e42c7bc15b463#,
                          16#8e1f98b13b204428#,
                          16#5632a803afa973eb#,
                          16#de0ff244877ea60a#,
